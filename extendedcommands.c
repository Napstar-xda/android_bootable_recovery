...
void show_install_update_menu()
{
    ...
    if (volume_for_path("/emmc") != NULL) {
        other_sd = "/emmc/";
        install_menu_items[3] = "zip >> internal sd";
    }
    else if (volume_for_path("/external_sd") != NULL) {
        other_sd = "/external_sd/";
        install_menu_items[3] = "zip >> external sd";
    }
...
void show_nandroid_menu()
{
    ...
    if (volume_for_path("/emmc") != NULL) {
        other_sd = "/emmc";
        list[6] = "backup >> int sd";
        list[7] = "rest << int sd";
        list[8] = "adv rest << int sd";
        list[9] = "del int sdcard";
    }
    else if (volume_for_path("/external_sd") != NULL) {
        other_sd = "/external_sd";
        list[6] = "backup >> ext sd";
        list[7] = "rest << ext sd";
        list[8] = "adv rest << ext sd";
        list[9] = "del ext sdcard";
    }
